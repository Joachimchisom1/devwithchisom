...
import ProfilePic from '../../public/images/profile/wakimkings.png'
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:bg-dark ">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div
              className="w-1/2 flex flex-col items-center self-center dark:text-light
            ...
            >
              ...
              <div className="flex items-center self-start mt-2 gap-6 lg:self-center">
                ...
                <Link
                  href="mailto:joachimchisom1@gmail.com"
                  target={'_blank'}
                  className="text-lg font-medium capitalize text-dark dark:text-light underline
                md:text-base"
                >
                  Contact
                </Link>
